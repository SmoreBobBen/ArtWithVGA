...
HD_PWD='/home/bdwatkin/Desktop/ArtWithVGA/ArtWithVGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ArtTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ArtTop.tcl -notrace
