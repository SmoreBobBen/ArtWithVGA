...
HD_PWD='/home/bdwatkin/Desktop/ArtWithVGA/ArtWithVGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ArtTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ArtTop.tcl
